...
// Lists of employment types ranges.
...
// Constants for job details API status.
...
// Image URL for failure view.
const failureViewImg =
  'https://assets.ccbp.in/frontend/react-js/failure-img.png'

// Class component 'AllJobs' representing the page displaying all jobs.
class AllJobs extends Component {
  // Initial state containing various data for rendering.
  state = {
    profileData: [],
    jobsData: [],
    checkboxInputs: [],
  ...
  // Lifecycle method: Fetches user profile details and job details when component mounts
  componentDidMount = () => {
  ...
  // Fetches job details based on filters from the API.
  ...
  // Handles the selection of radio options for salary ranges.
  onGetRadioOption = event => {
    this.setState({radioInput: event.target.id}, this.onGetJobDetails)
  }

  // Handles the selection of checkbox options for employment types.
  ...
  // Handles retrying the user profile fetch in case of failure.
  onRetryProfile = () => {
    this.onGetProfileDetails()
  }

  // Renders the failure view for the user profile.
  ...
  // Renders the appropriate user profile view based on API status.
  ...
  // Handles retrying the job details fetch in case of failure.
  onRetryJobs = () => {
    this.onGetJobDetails()
  }

  // Renders the failure view for job details.
  ...
  // Renders the view for the fetched jobs.
  onGetJobsView = () => {
  ...
  // Renders the appropriate view for job details based on API status.
  onRenderJobsStatus = () => {
  ...
  // Renders checkboxes for employment types.
  onGetCheckBoxesView = () => (
  ...
  // Renders radio buttons for salary ranges.
  ...
  // Handles user input for the search field.
  ...
  // Handles search input submission on pressing Enter.
...
// Exporting the AllJobs component as the default export.
